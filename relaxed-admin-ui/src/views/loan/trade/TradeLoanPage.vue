<template>
  <div class="app-container">
    ...
    >
      <template #tradeStatus="scope">
        <dict-text dict-code="trade_status" :value="scope.row.tradeStatus"></dict-text>
      </template>
    </yi-pro-table>
    <!--模态表单组件-->
...
<script>
  ...
  //页面相关请求方法
  import {getTradeLoanPage, addObj, putObj, delObj} from "@/api/loan/trade";
