...
public class ProjectTemplateController {
	...
	@GetMapping("/page")
	public R<PageResult<ProjectTemplatePageVO>> getProjectTemplatePage(PageParam pageParam,
			@Valid ProjectTemplateQO projectTemplateQO) {
	...
	public R<Void> save(@RequestBody ProjectTemplate projectTemplate) {
		return projectTemplateService.save(projectTemplate) ? R.ok()
				: R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "新增项目模板配置表失败");
	}
	...
	public R<Void> saveSignInfo(@RequestBody ProjectTemplateSignReqDTO projectTemplateSignReqDTO) {
		return projectTemplateService.saveSignInfo(projectTemplateSignReqDTO) ? R.ok()
				: R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "新增项目签章配置失败");
	}
	...
	public R<Void> updateById(@RequestBody ProjectTemplate projectTemplate) {
		return projectTemplateService.updateById(projectTemplate) ? R.ok()
				: R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "修改项目模板配置表失败");
	}
	...
	public R<Void> removeById(@PathVariable("projectTemplateId") Integer projectTemplateId) {
		return projectTemplateService.removeById(projectTemplateId) ? R.ok()
				: R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "通过id删除项目模板配置表失败");
	}
