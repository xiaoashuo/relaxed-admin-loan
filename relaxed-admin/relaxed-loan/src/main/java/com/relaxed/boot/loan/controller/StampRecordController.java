...
public class StampRecordController {
    ...
    @GetMapping("/page" )
    public R<PageResult<StampRecordPageVO>> getStampRecordPage(
            PageParam pageParam, StampRecordQO stampRecordQO) {
    ...
    public R<Void> save(@RequestBody StampRecord stampRecord) {
        return stampRecordService.save(stampRecord) ?
                R.ok() : R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "新增签章记录失败");
    }
    ...
    public R<Void> updateById(@RequestBody StampRecord stampRecord) {
        return stampRecordService.updateById(stampRecord) ?
                R.ok() : R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "修改签章记录失败");
    }
    ...
    public R<Void> removeById(@PathVariable("stampRecordId") Integer stampRecordId) {
        return stampRecordService.removeById(stampRecordId) ?
                R.ok() : R.failed(BaseResultCode.UPDATE_DATABASE_ERROR, "通过id删除签章记录失败");
    }
