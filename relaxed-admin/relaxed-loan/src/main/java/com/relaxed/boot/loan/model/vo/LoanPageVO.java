 ...
 */
@Data
@Schema(title = "借款合同表分页视图对象")
public class LoanPageVO {
	 ...
	 */
	@Schema(title = "证件类型，枚举值：1-户口簿2-护照5-港澳居民来往内地通行证6-台湾同胞来往内地通行证8-外国人居留证9-警官证A-香港身份证B-澳门身份证C-台湾身份证X-其他证件10-居民身份证及其他以公民身份证号码为标识的证件20-军人身份证件",
			description = "证件类型，枚举值：1-户口簿2-护照5-港澳居民来往内地通行证6-台湾同胞来往内地通行证8-外国人居留证9-警官证A-香港身份证B-澳门身份证C-台湾身份证X-其他证件10-居民身份证及其他以公民身份证号码为标识的证件20-军人身份证件")
	 ...
	 */
	@Schema(title = "还款方式（0:等额本息 1:等额本金 2:先息后本 3:月息季本 4:X+Y,X期先息后本，Y期等额本金 5:一次性还本付息）",
			description = "还款方式（0:等额本息 1:等额本金 2:先息后本 3:月息季本 4:X+Y,X期先息后本，Y期等额本金 5:一次性还本付息）")
	 ...
	 */
	@Schema(title = "借款状态(20:待放款21:放款成功/还款中22:放款失败30:已结清40:回购中 99:转出)",
			description = "借款状态(20:待放款21:放款成功/还款中22:放款失败30:已结清40:回购中 99:转出)")
