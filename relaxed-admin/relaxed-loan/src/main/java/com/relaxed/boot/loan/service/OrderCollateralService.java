 ...
 */
public interface OrderCollateralService extends ExtendService<OrderCollateral> {
    ...
    */
    PageResult<OrderCollateralPageVO> queryPage(PageParam pageParam, OrderCollateralQO qo);
