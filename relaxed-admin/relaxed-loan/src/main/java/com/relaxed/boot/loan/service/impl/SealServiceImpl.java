        ...
        if (SealEnum.SEAL_SOURCE.SYSTEM.getVal().equals(sealSource)){
            ...
            if (SealEnum.SEAL_TYPE.OFFICIAL.getVal().equals(sealPictureType)){
                ...
                SealGenerate.builder()
                        .size(200).borderCircle(SealCircle.builder().line(4).width(95).height(95).build())
                        ...
                        .titleFont(SealFont.builder().text("Relaxed发布").size(16).space(8.0).margin(54).build()).build().drawToOutStream(outputStream);
