 ...
 * @author Yakir
 * @Topic KeystoreMeta
 * @Description CN: 名字与姓氏 OU : 组织单位名称 O ：组织名称 L : 城市或区域名称 E : 电子邮件 ST: 州或省份名称 C:
 * 单位的两字母国家代码
...
public class KeystoreMeta {
	...
	public static void main(String[] args) {
		KeystoreMeta keystoreMeta = new KeystoreMeta().password("123456").certificateCRL("https://relaxed.cn")
				.alias("xiaoxi").subject().CN("Yakir").OU("relaxed研发部").O("relaxed有限公司").L("上海").E("relaxed@qq.com")
				.ST("上海").C("CN").end().issuer().CN("Yakir").OU("relaxed研发部").O("relaxed有限公司").L("上海").ST("上海").C("CN")
				.end();
