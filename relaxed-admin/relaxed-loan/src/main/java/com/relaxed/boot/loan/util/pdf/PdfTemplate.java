...
public class PdfTemplate {
	...
	public static void main(String[] args) throws Exception {
		...
		String targetPath = "D:\\other\\100000\\local\\profile\\contract\\20230130\\" + IdUtil.getSnowflakeNextIdStr()
				+ ".pdf";
	...
	public static void addImage(InputStream source, OutputStream dest, ImageSignMeta signMeta) {
		try (PdfReader pdfReader = new PdfReader(source);
			...
			for (KeywordLocation keywordLocation : keywordLocationList) {
				...
				for (IPdfTextLocation ipdfTextLocation : ipdfTextLocations) {
					...
					// Rectangle rectangle = new Rectangle(0, image.getImageHeight() + 80,
					// image.getImageWidth() + 100,
	...
	@SneakyThrows
	public static List<KeywordLocation> extractKeywordLocation(File source, String keyword) {
		return extractKeywordLocation(new FileInputStream(source), null, keyword);
	}

	@SneakyThrows
	public static List<KeywordLocation> extractKeywordLocation(File source, Integer specifyPageNum, String keyword) {
		return extractKeywordLocation(new FileInputStream(source), specifyPageNum, keyword);
	}

	@SneakyThrows
	public static List<KeywordLocation> extractKeywordLocation(InputStream source, String keyword) {
	...
	public static List<KeywordLocation> extractKeywordLocation(InputStream source, Integer specifyPageNum,
			String keyword) {
